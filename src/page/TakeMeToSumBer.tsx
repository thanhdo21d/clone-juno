  ...
  return (
      ...
      <div className="flex gap-8 mt-10">
                  <div className="relative">
                      <p className="absolute w-[100px] h-[40px] border-2 mt-3 ml-3 pl-2 pt-1 cursor-pointer font-extralight">Hàng Mới</p>
          <img className='mb-3 transition-all  h-[360px] w-[480px] ease-in-out rounded-lg cursor-pointer ' src={hoveredImg === Tui14 ? Tui15 : Tui14} onMouseEnter={() => handleImageHover(Tui14)} onMouseLeave={() => handleImageHover(null)} />
          ...
          <img className='mb-3 h-[360px] w-[480px]  transition-all ease-in-out rounded-lg cursor-pointer ' src={hoveredImg === Tui18 ? Tui17 : Tui18} onMouseEnter={() => handleImageHover(Tui18)} onMouseLeave={() => handleImageHover(null)} />
          ...
          <img className='mb-3 transition-all  h-[360px] w-[480px] ease-in-out rounded-lg cursor-pointer ' src={hoveredImg === Tui20 ? Tui16 : Tui20} onMouseEnter={() => handleImageHover(Tui20)} onMouseLeave={() => handleImageHover(null)} />
          <p className='text-center text-[15px] text-slate-500 font-extralight'>Áo thun trắng cổ tim</p>
          <span className='text-center block text-[##252a2b]  font-bold'>299,000</span>
              </div>
              {/*  */}
          ...
          <img className='mb-3 transition-all  h-[360px] w-[480px] ease-in-out rounded-lg cursor-pointer ' src={hoveredImg === Tui21 ? Tui15 : Tui21} onMouseEnter={() => handleImageHover(Tui21)} onMouseLeave={() => handleImageHover(null)} />
          <p className='text-center text-[15px] text-slate-500 font-extralight'>Áo thun trắng cổ tim</p>
          ...
          <div className='container mx-auto'>
              ...
              <div className='flex  gap-8 mt-10'>
                  <div className=''>
                      ...
                      <p className='cursor-pointer font-bold text-center mt-2'>Xem chi tiết</p>
