...
const Footer = () => {
  ...
  return (
    <Selection>
      <div>
        <div className="container mx-auto mt-20">
          ...
          <div className="grid grid-cols-3 gap-12 mt-10">
            <div className="">
              <p className="leading-8 tracking-wider font-extralight">
                GỌI MUA HÀNG ONLINE (08:00 - 21: 00 mỗi ngày)
              </p>
              <span className="pt-2 pb-2">1800 1162</span>
              <p className="leading-8 tracking-wider font-extralight pb-2">
              ...
              <span>1800 1160</span>
              <p className="leading-8 tracking-wider font-extralight pt-2">
                Tất cả các ngày trong tuần (Trừ tết Âm Lịch)
              </p>
            </div>
            {/*  */}
            <div>
              <h1 className="leading-8 tracking-wider font-extralight">
                HỆ THỐNG SHOWROOM
              </h1>
              <img className="my-3" src={Img5} />
              <a
                className="leading-8 tracking-wider font-extralight"
                href="facebook.com"
              >
                Xem địa chỉ hệ thống 68 showroom{" "}
              </a>
              <hr />
            </div>
            {/*  */}
            ...
            <div>
              <h2 className="leading-8 tracking-wider font-extralight">
      ...
      {/*  */}
      <div
        className="mt-10 w-full h-[70px] "
        style={{ backgroundColor: "rgba(0,0,0,0.07)" }}
      >
        <div className="flex gap-32 pt-5 pl-4 ">
          <h2
            className="cursor-pointer dropdown relative ease-in-out transition-all"
          ...
          {isDropdownOpen && (
            <div className="absolute mt-10 ">
              <ul>
                <li className="leading-8 tracking-wider font-extralight">
                  Hướng dẫn chọn cỡ giày
                </li>
                <li className="py-2 leading-8 tracking-wider font-extralight">
                  Chính sách đổi trả
                </li>
                <li className="leading-8 tracking-wider font-extralight">
          ...
          <h3 className="cursor-pointer">
            VỀ JUNO <i className="fa fa-chevron-down"></i>
          </h3>
        </div>
      </div>
